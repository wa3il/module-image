...
OBJS_TEST = ./obj/mainTest.o ./obj/Image.o ./obj/Pixel.o
OBJS_EXEMPLE = ./obj/mainExemple.o ./obj/Image.o ./obj/Pixel.o
OBJS_AFFICHAGE = ./obj/mainAffichage.o ./obj/Image.o ./obj/Pixel.o 
...
./bin/exemple: $(OBJS_EXEMPLE)
	$(CC) $(FLAGS) $(OBJS_EXEMPLE) -o ./bin/exemple $(LIBS_SDL)
